...
#Compile scripts
using EzXML
include("/home/cse/phd/csz158491/Centrality/Infection_group_protection/Vulner_vary/repeat_vulner.jl")
...
#S=[ 9, 24]
#CSV.write("SIR_p.csv",DataFrame(S'), append=true)
#s4=[34,33,1,24,3,30,9,7,2,8,16,19,32,4,31,28,6,14,26,27,5,29,25,20,17,11,15,21,23,10,13,18,22,12]#ordering of nodes based on personalized pagerank
#x=[7,10,14,17,20]# vulnerability %ges
#Compute functions. Repeat experiments 1000 times.
#compute_met_P(1000,M,S,s4,0.6,0.6,x,10)#SIR model ### Change Vaccinated set sizes according to graph i.e., [2,4,6,8,10]### vary 10 - 60% of total nodes
###Lesmiserables.gml
...
x=[15,23,31,39,46]# vulnerability %ges
#Compute functions. Repeat experiments 1000 times.
...
#x=[12,19,25,31,37]# vulnerability %ges
#Compute functions. Repeat experiments 1000 times.
...
#x=[23,35,46,58,69]# vulnerability %ges
#Compute functions. Repeat experiments 1000 times.
